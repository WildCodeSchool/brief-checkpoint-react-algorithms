  ...
  return (
    <>
      ...
      <section className="instructions">
        ...
        <p>
          For this step, get the accessory list from the API. You can do the
          fetch <strong>using an effect</strong>.
        </p>
        <p>
...
`}
      ...
      <section className="instructions">
        ...
        <p>
          ...
          <em>before</em> or <em>after</em> rendering the page if you're not
          familiar with route loaders ;)).
        </p>
      </section>
    </>
  );
